...
<div class="row" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        <ul class="list-group">
            ...
            <i class="fas fa-print fa-5x fa-fw mr-1"></i><b><p style="font-size:120%;">Report</p></b>
            </li>

            
            <a href="rep.php" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
            ...
            <a href="repkesiswaan.php" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    <span  class="fas fa-user-graduate fa-fw mr-3"></span>
                    <b><span class="menu-collapsed">Kesiswaan</span></b>
                    
                   
                </div>
            </a>

            <a href="repkepegawaian.php" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    <span class="fas fa-user-friends fa-fw mr-3"></span>
                    <b><span class="menu-collapsed">Kepegawaian</span></b>
            ...
            <a href="#submenu1" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    <span  class="fas fa-school fa-fw mr-3"></span>
                    <b><span class="menu-collapsed">Akademik</span></b><i class="fas fa-arrow-down fa-fw ml"></i>
            ...
            <div id='submenu1' class="collapse sidebar-submenu">
                ...
                <a href="impordatasiswa.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed"><i class="fas fa-angle-double-right fa fw-mr-3"></i> Absensi Pelajaran</span>
                    
                </a>

                <a href="datasiswa.php" class="list-group-item list-group-item-action bg-dark text white">
                    <span class="menu-collapsed"><i class=""></i>Nilai</span>
                </a>
           ...
           <a href="#submenu2" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    <span class="fas fa-user-check fa-fw mr-3"></span>
                    <b><span class="menu-collapsed">Persetujuan</span></b><i class="fas fa-arrow-down fa-fw ml"></i>
                </div>
            </a>
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="pelajaran.php" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed"><i class="fas fa-angle-double-right fa fw-mr-3"></i> Catatan Wali Kelas BP/BK</span>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
  <li class="breadcrumb-item"><b><a href="rep.php">Report</a></b></li>
...
<div class="card text-dark">
            <div class="card-header bg-primary"><b><i class="fas fa-exclamation fa-fw"></i>Informations</b></div>
              
                <div class="card-body text-dark">

                <ol>
                  <li><b>Laporan Kesiswaan</b></li>
                    <p>Menampilkan laporan dari data atau informasi siswa.</p>
                    <li><b>Laporan Kepegawaian</b></li>
                      <p>Menampilkan laporan dari data atau informasi tentang pegawai.</p>
                    <li><b>Laporan Akademik</b></li><br>
                      <ol type="a">
                        <li><b>Nilai Siswa</b></li>
                          <p>Menampilkan nilai masing-masing siswa per semester.</p>
                        <li><b>Absensi</b></li>
                          <p>Menampilkan laporan absensi dari permasing-masing siswa.</p>
                        <li><b>Raport</b></li>
                          <p>Menampilkan laporan hasil pencapaian siswa permaisng-masing siswa.</p>
                      </ol>
                <li><b>Laporan Keuangan</b></li>
                  <ol type="a">
                    <li><b>Laporan Posisi Keuangan</b></li>
                     <p>Menampilkan laporan dari posisi keuangan sekolah per jangka waktu yang ditentukan.</p>
                    <li><b>Laporan Laba Rugi</b></li>
                      <p>Menampilkan laporan dari laba/rugi</p>
                    <li><b>Laporan Cashflow</b></li>
                      <p>Menampilkan laporan aliran kas perjangka waktu yang ditentukan.</p>
                    </ol>
                  </ol>
