...
<div class="row" id="body-row">
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        <ul class="list-group">
            ...
            <i class="fas fa-book-reader fa-5x fa-fw mr-1"></i><b><p style="font-size:120%;">Akademik</p></b>
                
            </li>
            
            <a href="datajadwal.php" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    <span class="far fa-list-alt fa-fw mr-3"></span>
                    <b><span class="menu-collapsed">Jadwal</span></b>
            ...
            <a href="absensipelajaran.php" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    <span class="fas fa-clipboard-list fa-fw mr-3"></span>
                    <b><span class="menu-collapsed">Absensi Pelajaran</span></b>
                    
                   
                </div>
            </a>

            <a href="penilaian.php" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    
                    <span class="far fa-edit fa-fw mr-3"></span>
                    <b><span class="menu-collapsed">Penilaian</span></b>
           ...
           <a href="#submenu2" data-toggle="collapse" aria-expanded="false" class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center" float="relative">
                    <span class="fas fa-book-open fa-fw mr-3"></span>
            ...
            <a href="gantipass.php"  class="bg-dark list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-start align-items-center">
                    <span class="fas fa-user-lock fa-fw mr-3"></span>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-cog fa-fw mr-1"></i>
          <b>Informasi Akun</b></a>

    
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="#"><b>Ganti Password</b></a>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><b><a href="akademik.php">Akademik</a></b></li>
...
<div class="card text-dark">
            <div class="card-header bg-primary"><b><i class="fas fa-exclamation fa-fw"></i>INFORMASI</b></div>
                ...
                <hr>
                  <ol>
                    <li><b>Jadwal</b></li>
                    <p>Menampilkan Jadwal Utk Guru</p>

                    <li><b>Absensi Pelajaran</b></li>
                    <p>Menu ini berfungsi untuk melakukan absensi setiap pelajaran</p>

                    <li><b>Penilaian</b></li>
                    <p>Menu ini berfungsi untuk mengelola nilai siswa untuk setiap pelajaran</p>

                    <li><b>Rapor</b></li>
                    <p>Menu ini berfungsi untuk mengelola nilai setiap pelajaran dan memasukannya kedalam nilai raport</p>

                    <li><b>Ganti Password</b></li>
                    <p>Demi keamanan akun anda, anda diharapkan untuk mengganti password default yang diberikan oleh system kami</p>
