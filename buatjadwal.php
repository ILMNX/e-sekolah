...
<div class="row" id="body-row">
  ...
  <!--main-->
    ...
    <div class="container">
            <form action="simpanjadwal.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
            <br>
            <h1 class="display-5"> INPUT JADWAL</H1>
            <hr>
            <br>
                <div class="form-group row">
                    <label for="jam" class="col-md-1">Jam</label>
                        <div class="col-md-4">

                            <select name="jam" id="jam" class="form-control" >
                                <option value="" selected>--Pilih Jam--</option>
                                <option value="" >07.00-07.45</option>
                                <option value="">08.00-08.45</option>
                                <option value="">09.00-09.45</option>
                                <option value="">10.00-10.45</option>
                                ...
                                <option value="">15.00-15.45</option>
                                <option value="">16.00-16.45</option>
                                <option value="">17.00-17.45</option>
                                <option value="">20.00-20.45</option>
                                <option value="">21.00-21.45</option>
                            </select>
                        </div>
                </div>               
                ...
                <div class="form-group row">
                    <label for="senin"class=col-md-1>Senin</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="text" name="senin" id="senin" placeholder="Masukkan Jadwal Senin" class="form-control" ><br>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="selasa"class=col-md-1>Selasa</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="text" name="selasa" id="selasa" placeholder="Masukkan Jadwal Selasa" class="form-control" ><br>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="rabu"class=col-md-1>Rabu</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="text" name="rabu" id="rabu" placeholder="Masukkan Jadwal Rabu" class="form-control" ><br>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="kamis"class=col-md-1>Kamis</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="text" name="kamis" id="kamis" placeholder="Masukkan Jadwal Kamis" class="form-control" ><br>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="jumat"class=col-md-1>Jumat</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="text" name="jumat" id="jumat" placeholder="Masukkan Jadwal Jumat" class="form-control"><br>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="sabtu"class=col-md-1>Sabtu</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="text" name="sabtu" id="sabtu" placeholder="Masukkan Jadwal Sabtu" class="form-control" ><br>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="Minggu"class=col-md-1>Minggu</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="text" name="minggu" id="minggu" placeholder="Masukkan Jadwal Minggu" class="form-control" ><br>
                    </div>
                </div>
<hr><br>

                <button type="submit" class="btn btn-success">Simpan</button>
                <a href ="datajadwal.php" class="btn btn-primary">Jadwal</a>
