        ...
        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <img class="img img-responsive rounded-circle mb-3" width="160" src="img/<?php echo $_SESSION['username']['photo'] ?>" />
                    
                    <h3><?php echo  $_SESSION["username"]["name"] ?></h3>
                    <p><?php echo $_SESSION["username"]["email"] ?></p>

                    <p><a href="logout.php" onclick="return confirm('Are You Sure..?')">Logout</a></p>
                </div>
            </div>
