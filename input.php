...
<div class="container">
            <form action="simpan.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
            <br>
            <b>
            <h1 class="display-5"> INPUT MAHASISWA</H1>
            <hr>
            <br>

                <font size="3px">
                <div class="form-group row">
                    <label for="nim"class=col-md-1>NIM</label><label>:</label> 
                        <div class="col-md-4">
                        
                        <input type="number" name="nim" id="nim" placeholder="Masukkan Nim" class="form-control" required><br>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="nama"class=col-md-1>Nama</label><label>:</label> 
                        <div class="col-md-6">
                            <input type="text" name="nama" id="nama" placeholder="Masukkan Nama" class="form-control" required><br>
                        </div>
                </div>          

                <div class="form-group row">
                        <label for="email"class=col-md-1>Email</label><label>:</label> 
                    <div class="col-md-6">
                        <input type="email" name="email" id="email" placeholder="Masukkan Email" class="form-control" required><br> 
                    </div>
                </div>

                <div class="form-group row">
                        <label for="jenis_kelamin"class=col-md-1>Jenis Kelamin</label><label>:</label> 
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                        <label for="tanggal_lahir" class="col-md-1">Tanggal Lahir</label><label>:</label> 
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                        <label for="jurusan"class=col-md-1>Jurusan</label><label>:</label> 
                    <div class="col-md-4">
                        ...
                        <a href="input.php" class="btn btn-info" >Tambah Jurusan</a>
                ...
                <div class="form-group row">
                        <label for="alamat" class="col-md-1">Alamat</label><label>:</label> 
                    <div class="col-md-6">
                        <textarea name="alamat" id="alamat" class="form-control" required></textarea><br>
                    </div>
                </div>

                <div class="form-group row">
                        <label for="agama" class="col-md-1">Agama</label><label>:</label> 
                    <div class="col-md-6">
                ...
                <a href="data.php" class="btn btn-danger">Data</a>
