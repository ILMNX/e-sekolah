...
$data_mahasiswa = $koneksi->query("SELECT * FROM tugas");//mengambil semua field di tabel mahasiswa
while ($data= $data_mahasiswa->fetch(PDO::FETCH_ASSOC)){
    echo "<tr>
        <td>$data[nama_dosen]</td>
        <td>$data[tanggal_kumpul]</td>
        ...
        <td> 
             <a href='deletetugas.php?id=$data[id]' class='btn btn-danger' onclick='return confirm(\"apakah anda yakin?\")'>Hapus<a/>
        </td>
        <td>
    ...
    <a href="resettugas.php" class="btn btn-warning" onclick="return confirm('apakah anda yakin?')">Reset All</a>
    <a href="inputtugas.php" class="btn btn-primary">Tambah Tugas</a>
